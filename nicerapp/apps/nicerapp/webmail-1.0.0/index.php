...
<head>
    ...
    <link type="text/css" rel="StyleSheet" media="screen" href="webmail-<?php echo $theme?>.css?changed=<?php echo webmail_get_current_datetime_stamp();?>">
    ...
    <script type="text/javascript"  src="tinymce-4.8.0/js/tinymce/tinymce.min.js"></script>
    <link rel="stylesheet" href="tinymce-4/themes/whiteTransparent/editor.na.css">
    <script src="jquery-3.5.1.js"></script>
    <script src="jquery-ui-1.12.1/jquery-ui.js"></script>
    <script src="pouchdb/pouchdb-7.2.1.js"></script>
    <script type="text/javascript"  src="webmail.js?changed=<?php echo webmail_get_current_datetime_stamp();?>"></script>
    <script src="https://smtpjs.com/v3/smtp.js"></script>
</head>
<body onload="webmail.init();" onresize="webmail.onresize(event);">
                ...
                <thead>
                    <tr>
                        <td class="pictogramButton__td">
                            <img id="btnWriteMail" src="images/writeMail6.png" title="Write mail" onclick="webmail.writeMail()" class="btn pictogramButton pictogramButton__onoff"/>
                        </td>
                        <td class="pictogramButton__td">
                            <img id="btnSendMail" src="images/sendMail.png" title="Send mail" onclick="webmail.sendMail()" class="btn pictogramButton pictogramButton__onoff pictogramButton__off"/>
                        </td>
                        <td class="pictogramButton__td">
                            <img id="btnReplyMail" src="images/replyMail.png" title="Reply to mail" onclick="webmail.replyMail()" class="btn pictogramButton pictogramButton__onoff pictogramButton__off"/>
                        </td>
                        <td class="pictogramButton__td">
                            <img id="btnForwardMail" src="images/forwardMail.png" title="Forward mail" onclick="webmail.forwardMail()" class="btn pictogramButton pictogramButton__onoff pictogramButton__off"/>
                        </td>
                        <td class="pictogramButton__td">
                            <img src="images/btnUp.png" title="Show later mails" onclick="webmail.getMailboxContent_nextPage()" class="btn btnUp btnShowNextEmails pictogramButton"/>
                        </td>
                        <td class="pictogramButton__td">
                            <img src="images/btnDown.png" title="Show older mails" onclick="webmail.getMailboxContent_prevPage()" class="btn btnDown btnShowPreviousEmails pictogramButton"/>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </thead>
