        ...
        <style>
            ...
            <div id="siteContent__header" class="saHeaderInDialog" style="position:absolute;width:100%;height:2em">
                <table id="newsApp_title_table" style="width:100%;">
                    <tr>
                        <td style="width:1%;white-space:nowrap;margin:5px;vertical-align:middle;">
                        ...
                        <img id="newsApp_lock" class="btn" src="/nicerapp/apps/nicerapp/news/btnLock_off.png" onclick="na.apps.loaded.newsApp.toggleLock();" style="vertical-align:middle;height:2em;display:none;z-index:9999999999999;" title="[SPACE] pauses"/>
                        <img id="newsApp_next" class="btn" src="/nicerapp/apps/nicerapp/news/btnNext.png" onclick="na.apps.loaded.newsApp.gotoNextPage();" style="vertical-align:middle;height:2em;display:none;z-index:9999999999999;" title="[ALT] goes to next page"/>
                        </td>
                    </tr>
                </table>
