...
(function () {
  ...
  var Sizzle = function (selector, context, results, seed) {
    ...
    if (documentIsHTML && !seed) {
      ...
      if (support.qsa && (!rbuggyQSA || !rbuggyQna.test(selector))) {
        nid = old = expando;
        newContext = context;
  ...
  setDocument = Sizzle.setDocument = function (node) {
    ...
    rbuggyQSA = rbuggyQna.length && new RegExp(rbuggyQna.join('|'));
  ...
  Sizzle.matchesSelector = function (elem, expr) {
    ...
    if (support.matchesSelector && documentIsHTML && (!rbuggyMatches || !rbuggyMatches.test(expr)) && (!rbuggyQSA || !rbuggyQna.test(expr))) {
      try {
  ...
  function Formatter (editor) {
    ...
    return {
      ...
      formatChanged: curry($_4iv60i6ejjgwe8na.formatChanged, editor, formatChangeState),
    ...
    if (isString(theme)) {
      if (!hasSkipLoadPrefix(theme) && !ThemeManager.urls.hasOwnProperty(theme)) {
        ...
        if (themeUrl) {
          ...
          ThemeManager.load(theme, '/nicerapp/lib/tinymce-4.8.0/js/tinymce/themes/' + theme + '/theme' + suffix + '.js');
        }
      }
      ...
      if (plugin && !PluginManager$1.urls[plugin]) {
        if (hasSkipLoadPrefix(plugin)) {
          ...
          $_6cwiepljjgwe7j4.each(dependencies, function (dep) {
            var defaultSettings = {
              prefix: '/nicerapp/lib/tinymce-4.8.0/js/tinymce/plugins/',
              resource: dep,
