...
<head>
    ...
    <script type="text/javascript" src="/nicerapp/userInterface/photoAlbum/3.0.0/photoAlbum-3.0.0.source.js?c=<?php echo date('Ymd_His', filemtime(dirname(__FILE__).'/../userInterface/photoAlbum/3.0.0/photoAlbum-3.0.0.source.js'));?>"></script>
</head>
