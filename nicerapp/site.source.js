...
var nas = na.site = {
    ...
    settings : {
        defaultStatusMsg : (
            ...
            : '<table style="width:100%;height:100%;"><tr><td>Copyright (c) 2021 by Rene A.J.M. Veerman</td><td style="width:220px;"><div class="vividButton" theme="dark" style="position:relative;color:white;" onclick="na.site.dismissCopyrightMessage();">Ok</div></td></table>'
        ),
        dialogs : {},
        buttons : {},
        menus : {},
    ...
    onresize : function(settings) {
        ...
        if ($(window).width() < 1000) {
            ...
            jQuery('#headerSite h1').css ({ fontSize : '200%', paddingLeft : 20 });
            jQuery('#headerSite h2').css ({ fontSize : '140%', paddingLeft : 20 });
