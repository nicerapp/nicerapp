            ...
            //debugger;
                ...
                for (var j=0; j<oa.items.length; j++) {
                    ...
                    if (it.model) {
                        ...
                        it.model.position.x = (p1it.model?p1it.model.position.x:0) + (200 * ox.modifierColumn * (ox.modifierColumn===-1?it.adjustedModXmin:it.adjustedModXadd)) + (it.modifierColumn * 50) + (commonParentIt.modifierColumn * it.column * 50);
                        ...
                        it.model.position.y = (p1it.model?p1it.model.position.y:0) + (200 * ox.modifierRow * (ox.modifierRow===-1?it.adjustedModYmin:it.adjustedModYadd)) + (it.modifierRow * 50) +  (commonParentIt.modifierRow * it.row * 50);
                        //debugger;
