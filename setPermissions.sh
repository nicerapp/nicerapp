...
chmod 777 nicerapp/domainConfigs/localhost_v2/index.combined.css nicerapp/domainConfigs/localhost_v2/index.combined.cssTheme.dark.css nicerapp/domainConfigs/localhost_v2/index.combined.cssTheme.light.css nicerapp/domainConfigs/localhost_v2/index.combined.js
